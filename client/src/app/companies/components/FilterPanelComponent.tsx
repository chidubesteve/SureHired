...
const FilterPanel = ({ onFiltersChange, initialFilters }: FilterPanelProps) => {
  ...
  useEffect(() => {
    ...
    setSelectedWorkStyles(initialFilters.workStyles);
  }, [initialFilters]);
  ...
  return (
    <div className="flex items-center gap-2">
      <Popover>
        ...
        <PopoverContent className="w-80 bg-white mx-4 !max-h-[--radix-popover-content-available-height] overflow-auto">
          {/* Filters Content */}
